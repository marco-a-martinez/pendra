...
// Force deployment - WYSIWYG editors completely removed - Trigger rebuild
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white min-h-[100px] resize-y"
              rows={3}
            />
          </div>
