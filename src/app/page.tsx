    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-2 flex items-center justify-center gap-3">
          ...
          Pendra
          <span className="text-lg font-normal text-blue-500">v0.1.3</span>
        </h1>
        <p className="text-gray-600">A simple, clean todo app with drag-and-drop reordering, due dates, and sections</p>
      </div>
